...
public class MainFrame extends javax.swing.JFrame {
    ...
    public final void setTableFrom (String strQuery) {
        int iCntRow = 0;
        ...
        try {
            ...
            while (DBM.DB_rs.next()) {
                jTable2.setValueAt((String)DBM.DB_rs.getString("No"), iCntRow, 0);
                jTable2.setValueAt((String)DBM.DB_rs.getString("Type"), iCntRow, 1);
                jTable2.setValueAt((String)DBM.DB_rs.getString("Displacement"), iCntRow, 2);
                jTable2.setValueAt((String)DBM.DB_rs.getString("Performance"), iCntRow, 3);
                jTable2.setValueAt((String)DBM.DB_rs.getString("Price"), iCntRow++, 4);
            }
        }
        catch (Exception e) {
            System.out.println("SQLException: " + e.getMessage());
    ...
    public final String makeSQLWhere (String strQuery) {
        switch(cboSearch.getSelectedIndex()) {
            case 0: strQuery += " Where CarInfo.No = '" + txtNo.getText() + "'";
                break;
            case 1: strQuery += " Where CarInfo.Type = '" + txtCarType.getText() + "'";
                break;
            case 2: strQuery += " Where CarInfo.Displacement = '" + txtCC.getText() + "'";
                break;
            case 3: strQuery += " Where CarInfo.Performace = '" + txtKM.getText() + "'";
                break;
            case 4: strQuery += " Where CarInfo.Price = '" + txtPrice.getText() + "'";
                break;
            default: strQuery = "SELECT * FROM CarInfo ";
                break;
        }
        return strQuery;
    }
    ...
    private void jTable2MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable2MouseClicked
        int iCntRow = 0;
        iCntRow = jTable2.getSelectedRow();
        
        txtNo.setText((String)jTable2.getValueAt(iCntRow, 0));
        txtCarType.setText((String)jTable2.getValueAt(iCntRow, 1));
        txtCC.setText((String)jTable2.getValueAt(iCntRow, 2));
        txtKM.setText((String)jTable2.getValueAt(iCntRow, 3));
        txtPrice.setText((String)jTable2.getValueAt(iCntRow, 4));
